...
public class DeviceWire extends AbstractBaseEntity {
...
//    @NotNull
    ...
    public DeviceWire(LocalDateTime dateTime, String registrationList, String typeOfCommunication, String location,
    ...
    public DeviceWire(Integer id, LocalDateTime dateTime, String registrationList, String typeOfCommunication, String location, String defect, String description, String responsibleEmployees, Boolean status) {
        super(id);
